...
4. **Git hooks**: Run `task hooks:install` to install the pre-push hook.
5. **README**: Replace the template README with project-specific content.
6. **This file**: Update this CLAUDE.md — remove this "First Use" section and add project-specific build/test instructions.
